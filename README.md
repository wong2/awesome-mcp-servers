...
- **[WaaSuP](https://github.com/SEOLinkMap/waasup)** - Composer/Packagist package for implementing your own remote MCP servers powered by PHP. Built with the complexities of multi-user, multi-tenant, multi-project SaaS in mind. This repo has a running MCP to aid with implementation and tool building.
