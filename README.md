...
- **[xbird](https://github.com/checkra1neth/xbird)** - Twitter/X MCP server with 30 tools — read, search, post, engage. Per-call x402 micropayments on Base. [![npm](https://img.shields.io/npm/v/xbird-mcp)](https://www.npmjs.com/package/xbird-mcp)
