...
- **[xcode-mcp](https://github.com/Coolblack-GmbH/xcode-mcp)** - 🍎 Complete Xcode automation with 59 tools for building, testing, signing, profiling, and deploying iOS, macOS, watchOS, tvOS, and visionOS apps via AI. One-line install, CI/CD generation, full simulator control.
