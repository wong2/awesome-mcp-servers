...
- **[Clawdentials](https://github.com/fernikolic/clawdentials)** - Trust layer for the agent economy — escrow, reputation, and analytics for AI agent commerce. Enables agents to accept paid tasks with guaranteed payment, build verifiable reputation, and earn money in USDC, USDT, or BTC.
