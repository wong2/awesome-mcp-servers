...
- **[Prisma Postgres MCP Server](https://pris.ly/docs/mcp-server)** - Gives LLMs the ability to manage [Prisma Postgres](https://pris.ly/ppg) databases (e.g. spin up new databases and run migrations or queries).
