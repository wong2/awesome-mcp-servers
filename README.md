...
- **[SuperLocalMemory V2](https://github.com/varun369/SuperLocalMemoryV2)** - Universal, local-first persistent memory for AI assistants. Single SQLite database shared across 17+ tools (Claude, Cursor, Windsurf, VS Code). 10-layer architecture with knowledge graph, pattern learning, and real-time event bus. Free forever, zero cloud dependencies.
