...
- **[dbt-docs](https://github.com/mattijsdp/dbt-docs-mcp)** - MCP server for dbt-core (OSS) users unlike the above. Supports project metadata, model and colum-level lineage and dbt documentation. 
