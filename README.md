...
- **[SSOJet Remot MCP Server]([https://github.com/ssojet/remote-mcp-ssojet.git])** – A simple MCP server secured with SSOJet login, includes an example tool and ready-to-deploy setup
