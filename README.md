...
- **[Artefact Revenue Intelligence](https://github.com/alexboissAV/artefact-mcp-server)** - Revenue intelligence MCP server with RFM analysis (11-segment classification), 14.5-point ICP scoring, and pipeline health scoring for B2B revenue teams. HubSpot integration with built-in sample data.
