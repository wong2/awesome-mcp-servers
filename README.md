...
- **[AgentPMT](https://github.com/Apoth3osis-ai/agentpmt-mcp-public)** - AI agent marketplace for creating automated employees and assistants. Dynamic MCP server connecting to the entire MCP ecosystem with budget-controlled tool discovery, purchasing, and orchestration at [AgentPMT](https://agentpmt.com).
