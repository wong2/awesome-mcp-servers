...
- **[Lcontext](https://github.com/Lcontext/Lcontext)** - Behavioral analytics MCP server providing page metrics, visitor profiles, session sentiment, and AI-generated user behavior insights for coding agents.
