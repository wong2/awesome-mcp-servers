...
- **[Hive Intelligence](https://github.com/hiveintelligencexyz/hive-mcp)** - Instant, deep blockchain and cryptocurrency data access for your AI agents and applications. Remote server, no local installation required [Hive Intelligence MCP](https://hiveintelligence.xyz/mcp-docs).
