...
- **[Synter Media](https://github.com/jshorwitz/synter-media)** - Cross-platform advertising MCP server for Google Ads, Meta, LinkedIn, Reddit, Microsoft, TikTok, and X. 100+ tools for campaign creation, reporting, optimization, and AI creative generation.
