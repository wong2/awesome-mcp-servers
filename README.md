...
- **[che-ical-mcp](https://github.com/kiki830621/che-ical-mcp)** - Native macOS Calendar & Reminders MCP server (24 tools). Swift/EventKit with recurring events, location triggers, search, batch operations, and multi-source calendar support.
