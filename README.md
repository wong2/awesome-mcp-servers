...
- **[Janee](https://github.com/rsdouglas/janee)** - Secrets management MCP server for AI agents. Acts as a secure proxy so agents get capability-scoped, auditable access to external services without ever seeing raw API keys.
