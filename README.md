...
- **[/vibe](https://github.com/VibeCodingInc/vibe-mcp)** - Social layer for Claude Code. Real-time presence, DMs, "Watch Me Code" terminal streaming, and gigs marketplace. 117 tools for collaborative AI coding.
