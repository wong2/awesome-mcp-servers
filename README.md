...
- **[run-sql-connectorx](https://github.com/gigamori/mcp-run-sql-connectorx)** - Execute SQL via ConnectorX and stream results to CSV/Parquet (Arrow RecordBatch). MCP tool: run_sql.
